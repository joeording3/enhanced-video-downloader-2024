...
const performance_utils_1 = require("../../extension/src/lib/performance-utils");
describe("Performance Utils Tests", () => {
    describe("Debounce Function", () => {
        it("should debounce function calls", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockFunction = jest.fn();
            const debouncedFunction = (0, performance_utils_1.debounce)(mockFunction, 100);
        ...
        it("should handle function arguments", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockFunction = jest.fn();
            const debouncedFunction = (0, performance_utils_1.debounce)(mockFunction, 100);
        ...
        it("should reset timer on subsequent calls", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockFunction = jest.fn();
            const debouncedFunction = (0, performance_utils_1.debounce)(mockFunction, 100);
            debouncedFunction();
    ...
    describe("Throttle Function", () => {
        it("should throttle function calls", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockFunction = jest.fn();
            const throttledFunction = (0, performance_utils_1.throttle)(mockFunction, 100);
            // Call multiple times rapidly
            throttledFunction();
            throttledFunction();
            throttledFunction();
        ...
        it("should not call function during throttle period", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockFunction = jest.fn();
            const throttledFunction = (0, performance_utils_1.throttle)(mockFunction, 100);
            throttledFunction();
            expect(mockFunction).toHaveBeenCalledTimes(1);
    ...
    describe("Memoize Function", () => {
        it("should memoize function results", () => {
            ...
            const memoizedFunction = (0, performance_utils_1.memoize)(expensiveFunction);
            // First call
        ...
        it("should handle complex arguments", () => {
            let callCount = 0;
            const complexFunction = (obj, arr) => {
                callCount++;
                return obj.value + arr.length;
            };
            const memoizedFunction = (0, performance_utils_1.memoize)(complexFunction);
            const obj1 = { value: 10 };
            const arr1 = [1, 2, 3];
        ...
        it("should handle different argument types", () => {
            let callCount = 0;
            const mixedFunction = (str, num, bool) => {
                callCount++;
                return `${str}-${num}-${bool}`;
            };
            const memoizedFunction = (0, performance_utils_1.memoize)(mixedFunction);
    ...
    describe("DOM Batcher", () => {
        it("should batch DOM operations", () => {
            const batcher = new performance_utils_1.DOMBatcher();
            const operations = [];
            // Add operations
    ...
    describe("Cache", () => {
        it("should store and retrieve values", () => {
            const cache = new performance_utils_1.Cache(1000); // 1 second max age
        ...
        it("should return undefined for missing keys", () => {
            const cache = new performance_utils_1.Cache();
            expect(cache.get("missing")).toBeUndefined();
        });
        it("should handle cache expiration", () => __awaiter(void 0, void 0, void 0, function* () {
            const cache = new performance_utils_1.Cache(50); // 50ms max age
            cache.set("key", "value");
        ...
        it("should handle different value types", () => {
            const stringCache = new performance_utils_1.Cache();
            const numberCache = new performance_utils_1.Cache();
            const objectCache = new performance_utils_1.Cache();
        ...
        it("should handle cache size limits", () => {
            const cache = new performance_utils_1.Cache(1000);
            // Add many items
    ...
    describe("Performance", () => {
        it("should handle high-frequency debounce calls efficiently", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockFunction = jest.fn();
            const debouncedFunction = (0, performance_utils_1.debounce)(mockFunction, 10);
        ...
        it("should handle high-frequency throttle calls efficiently", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockFunction = jest.fn();
            const throttledFunction = (0, performance_utils_1.throttle)(mockFunction, 10);
            const startTime = Date.now();
            // Call many times rapidly
            for (let i = 0; i < 1000; i++) {
                throttledFunction();
    ...
    describe("Error Handling", () => {
        it("should handle errors in memoized functions", () => {
            ...
            const memoizedFunction = (0, performance_utils_1.memoize)(errorFunction);
