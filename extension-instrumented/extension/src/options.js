...
exports.setupSearchFunctionality = setupSearchFunctionality;
exports.performSearch = performSearch;
exports.highlightMatchingText = highlightMatchingText;
exports.showNoResultsMessage = showNoResultsMessage;
...
function performSearch(query) {
    ...
    sections.forEach((section) => {
        var _a, _b, _c, _d;
        const sectionTitle = ((_b = (_a = section.querySelector(".section-title")) === null || _a === void 0 ? void 0 : _a.textContent) === null || _b === void 0 ? void 0 : _b.toLowerCase()) || "";
        const sectionContent = ((_c = section.textContent) === null || _c === void 0 ? void 0 : _c.toLowerCase()) || "";
        const sectionCategory = ((_d = section.getAttribute("data-category")) === null || _d === void 0 ? void 0 : _d.toLowerCase()) || "";
        // Check if any search term matches
        const matches = searchTerms.some((term) => sectionTitle.includes(term) ||
 ...
 */
function highlightMatchingText(section, searchTerms) {
    ...
    titleText = titleText.replace(/<mark class="search-highlight">(.*?)<\/mark>/g, "$1");
    // Add new highlights
    searchTerms.forEach((term) => {
        const regex = new RegExp("(" + term + ")", "gi");
        titleText = titleText.replace(regex, '<mark class="search-highlight">$1</mark>');
    });
...
function setupSearchSuggestions(searchInput) {
    ...
    (_a = searchInput.parentNode) === null || _a === void 0 ? void 0 : _a.appendChild(suggestionDropdown);
    searchInput.addEventListener("focus", () => {
        if (searchInput.value.trim()) {
            showSuggestions(searchInput.value.trim(), suggestions, suggestionDropdown);
        }
    });
    searchInput.addEventListener("input", () => {
 ...
 */
function showSuggestions(query, suggestions, dropdown) {
    ...
    dropdown.innerHTML = matchingSuggestions
        .map((suggestion) => '<div class="suggestion-item" data-suggestion="' +
        suggestion +
        '">' +
        suggestion +
        "</div>")
