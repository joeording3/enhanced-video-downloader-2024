...
def run_js_mutation_testing(target_files: List[str]) -> Dict:
    ...
    print("Running JavaScript mutation testing...")
...
def run_py_mutation_testing(target_files: List[str]) -> Dict:
    ...
    print("Running Python mutation testing...")
...
def main():
    ...
    if args.report_only:
        print("Report-only mode - no testing performed")
        return 0
    ...
    report = generate_report(analysis, changed_files)
    print(report)
    
    # Exit with appropriate code
    if args.ci and analysis["failed"] > 0:
        print("Mutation testing failed in CI mode")
        return 1
